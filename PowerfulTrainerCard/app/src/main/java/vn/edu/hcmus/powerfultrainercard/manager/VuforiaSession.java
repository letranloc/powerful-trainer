...
countries.
===============================================================================*/
package vn.edu.hcmus.powerfultrainercard.manager;
...
import vn.edu.hcmus.powerfultrainercard.PowerfulTrainerContants;
...
public class VuforiaSession implements UpdateCallbackInterface {
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            synchronized (mShutdownLock) {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, PowerfulTrainerContants.VUFORIA_KEY);
