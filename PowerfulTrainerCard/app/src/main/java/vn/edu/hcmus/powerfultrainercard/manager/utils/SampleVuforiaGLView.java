...
package vn.edu.hcmus.powerfultrainercard.manager.utils;
...
public class SampleVuforiaGLView extends GLSurfaceView {
    private static final String LOGTAG = "SampleVuforiaGLView";

    // Constructor.
    public SampleVuforiaGLView(Context context) {
        super(context);
    }
